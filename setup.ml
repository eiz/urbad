...
(* OASIS_START *)
(* DO NOT EDIT (digest: 993f6c9d3ac89fd3f83e5db61760bedb) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Mack Straight"];
          homepage = None;
          bugreports = None;
          synopsis = "Uniform Random Boolean ALTTP Discombobulator";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("msat", None)];
                      bs_build_tools =
     ...
     oasis_digest = Some "\249\2234\232\\\208\tS6-2\223\231'\2389";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
